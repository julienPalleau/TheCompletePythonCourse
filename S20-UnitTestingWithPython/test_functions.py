...
class TestFunctions(TestCase):
    def test_divide_result(self):
        dividend = 15
        divisor = 3
        expected_restult = 5.0
        #   Both lines below are valid, depending on how your computer returns result 5 or 5.0001
        #   self.assertEqual(divide(dividend, divisor), expected_restult)
        self.assertAlmostEqual(divide(dividend, divisor), expected_restult, delta=0.0001)
